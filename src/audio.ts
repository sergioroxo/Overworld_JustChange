...
class AudioEngineImpl implements AudioEngine {
  ...
  private setupAmbient(): void {
    ...
    const day1 = this.createOsc(220, 'sine', 0.08);
    const day2 = this.createOsc(330, 'sine', 0.05);
    ...
    const night1 = this.createOsc(110, 'sine', 0.06);
    const night2 = this.createOsc(165, 'sine', 0.04);
  ...
  private createOsc(freq: number, type: OscillatorType, vol: number): OscillatorNode {
